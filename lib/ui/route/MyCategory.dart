...
class MyCategory extends StatelessWidget {
  ...
  /// Creates a [MyCategory].
  ///
  /// A [MyCategory] saves the name of the Category (e.g. 'Length'), its color for
  ...
  /// Builds a custom widget that shows [MyCategory] information.
  ///
  /// This information includes the icon, name, and color for the [MyCategory].
  @override
